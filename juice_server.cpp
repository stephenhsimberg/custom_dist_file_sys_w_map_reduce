...
void setup_tcp_server_communication_server_juice(std::string port_num) {
   ...
   freeaddrinfo(servinfo);
    ...
    while(1) {
        ...
        sent_recv_bytes =  recv(comm_socket_fd, (size_t *)&num_keys, sizeof(num_keys), 0);
        std::cout << num_keys << "\n";
        ...
        for(int i = 0; i < (int) num_keys; i++){
            ...
            std::cout << "recieved\n";
            std::string f_name("sysfiles/juice_input");
            std::ofstream ofs;
            ...
            std::string f2_name("sysfiles/juice_output");
        ...
        if(num_keys != 0){
            system("rm sysfiles/juice_output");
            system("rm sysfiles/juice_input");
        }
